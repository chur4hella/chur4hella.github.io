...
(function() {
    ...
    Chart.Tooltip = Chart.Element.extend({
        draw: function() {
            ...
            // chartLabelsHeight - объявлена в файле script.js
            ctx.lineTo(this.x, this.chart.height - chartLabelsHeight);
            ctx.lineWidth = 0.3;
        ...
        draw: function() {
            ...
            if (this.display) {
                ...
                each(this.xLabels, function(label, index) {
                    ...
                    var showLabel = false;
                    if (String(label).length > 3) {
                        var apYear = String(label).substr(-4);
                        if (!isNaN(apYear)) {
                            showLabel = true;
                        }
                    }
                    if (showLabel) { ctx.fillText(label, 0, 0); }
                    ctx.restore();
                }, this);
